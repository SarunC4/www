...
?>
  <tr>
    ...
    <td><div class="text-center"><a href="delete.php?delete_id=<?php echo $Result['ID']; ?>" class="btn btn-danger"><i class="far fa-trash-alt"></i></a> <a href="edit.php?edit_id=<?php echo $Result["ID"]; ?>" class="btn btn-warning"><i class="far fa-edit"></i></a></div></td>
  </tr>
<?php
}
?>
